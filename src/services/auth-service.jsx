...
const isLoggedIn = () => {
    return (LocalStorage.getValue(TOKEN_STORAGE_KEY, {}).accessToken !== {})
}

const getCurrentUser = () => {
    LocalStorage.getValue(USER_STORAGE_KEY, {});
}
const getAccessToken = () => {
    return LocalStorage.getValue(TOKEN_STORAGE_KEY, {}).accessToken
}
const getRefreshToken = () => {
    return LocalStorage.getValue(TOKEN_STORAGE_KEY, {}).refreshToken
}
