...
const Navbar = () => {
    ...
    return ReactDOM.createPortal(<>
        ...
        <div className="bg-blue-600  font-sans z-10">
            ...
            <div className={(navValues.sidebar ? ' left-[-300px] ' : '') + " z-40 select-none fixed top-0 bottom-0 lg:left-0 duration-500 " +
                " p-2 w-[300px] overflow-y-auto text-center bg-grd-dark shadow h-screen"}>
                <div className="text-gray-100 text-xl">
                    ...
                    <div>
                        ...
                        <div className={(navValues.projectdrop ? '  ' : 'hidden ') + " duration-500 leading-7 text-left  text-sm font-thin mt-2 w-4/5 mx-auto"}>
                            <h1 className="cursor-pointer p-2 hover:btn-sky rounded-md mt-1 pl-3">Add Project</h1>
                            <h1 className="cursor-pointer p-2 hover:btn-sky rounded-md mt-1 pl-3">All Projects</h1>
                        </div>
                        <div className="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer  hover:btn-purple"
                        ...
                        <div className={(navValues.userdrop ? '  ' : 'hidden ') + " leading-7 text-left text-sm font-thin mt-2 w-4/5 mx-auto"}>
                            ...
                            <Link to={'/'}><h1 className="cursor-pointer p-2 hover:btn-sky rounded-md mt-1 pl-3">All Member</h1></Link>
                        </div>
